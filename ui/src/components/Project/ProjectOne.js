    ...
    <section className="container">
      <div className="row projects-card">
        ...
        <div className="col-6 project-bio">
          ...
          <p>
            Assemble your team with Backyard Sports. With this application
          ...
          <p>
            <a href="https://github.com/Rilaey/Backyard-Sports">Github Repo</a>
          </p>
          <p>
            <a href="https://backyard-sports.herokuapp.com/">
              Live Application
            </a>
          </p>
        </div>
